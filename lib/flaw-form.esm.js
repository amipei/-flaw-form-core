...
var FormGroup = /*#__PURE__*/function (_AbstractControl) {
  ...
  _createClass(FormGroup, [{
    ...
    value: function _setControls(controls) {
      ...
      forEach$3(_context2 = keys$2(controls)).call(_context2, function (name) {
    ...
    value: function flush() {
      ...
      forEach$3(_context3 = this.queue).call(_context3, function (job) {
        var name = job.name,
            state = job.state;
        _this4.value[name] = state.value;
        _this4.errors = _this4.errors ? _objectSpread2(_objectSpread2({}, _this4.errors), {}, _defineProperty({}, name, state.errors)) : _defineProperty({}, name, state.errors);
        _this4.status[name] = state.status;
      });
