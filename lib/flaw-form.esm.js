...
var FormGroup = /*#__PURE__*/function (_AbstractControl) {
  ...
  _createClass(FormGroup, [{
    ...
    value: function _setControls(controls) {
      ...
      forEach$3(_context3 = keys$2(controls)).call(_context3, function (name) {
    ...
    value: function flush() {
      ...
      forEach$3(_context4 = this.queue).call(_context4, function (job) {
        var name = job.name,
            state = job.state;
        _this5.value[name] = state.value;
        ...
        _this5.status[name] = state.status;
      });
