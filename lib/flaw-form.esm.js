...
var slice_1 = function (it) {
  var own = it.slice;
  return it === ArrayPrototype$3 || (it instanceof Array && own === ArrayPrototype$3.slice) ? slice$3 : own;
};
...
var filter_1 = function (it) {
  var own = it.filter;
  return it === ArrayPrototype$2 || (it instanceof Array && own === ArrayPrototype$2.filter) ? filter$4 : own;
};
...
var AbstractControl = /*#__PURE__*/function () {
  ...
  _createClass(AbstractControl, [{
     ...
     * @param opts 
     */
    function _setStrategy(opts) {
      var _opts$trigger, _opts$validateAll, _opts$selfValidate;

      this.trigger = (_opts$trigger = opts === null || opts === void 0 ? void 0 : opts.trigger) !== null && _opts$trigger !== void 0 ? _opts$trigger : 'change';
...
var asyncValidate = function asyncValidate(context, validators) {
  ...
  var resultPromise = new promise(function (resolve, reject) {
    ...
    promise.allSettled(map(validators).call(validators, function (validator) {
      ...
      return regenerator.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              //cancelFn = () => reject(null);
              validatorsPromise = map(validators).call(validators, function (validator) {
                return validator(context);
              });
              errors = null;
...
var _DEFAULT_TRIGGER = new weakMap();

var _asyncSubscription = new weakMap();

var Validation = /*#__PURE__*/function () {
  function Validation(validators, asyncValidators, defaultTrigger) {
    ...
    _classPrivateFieldSet(this, _DEFAULT_TRIGGER, defaultTrigger);
  ...
  _createClass(Validation, [{
    ...
    value: function _coerceToValidatorMap(validator) {
      ...
      if (isArray$2(validator)) {
        forEach$3(validator).call(validator, function (v) {
          ...
          if (meta) {
            map.set(meta.validator, meta.trigger);
          }
        });
      } else {
    ...
    value: function _transformValidatorMeta(validatorFnOrMeta) {
      var trigger = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _classPrivateFieldGet(this, _DEFAULT_TRIGGER);
    ...
    value: function _filterByTrigger(map$1, trigger) {
      var _context, _context2;

      return map(_context = filter$2(_context2 = from(map$1)).call(_context2, function (meta) {
    ...
    key: "run",
    value: function run(context, subscriber, opts) {
      //取消上次的异步订阅
      ...
      if (_classPrivateFieldGet(this, _validatorMap).size) {
        var filterValidors = this._filterByTrigger(_classPrivateFieldGet(this, _validatorMap), opts.trigger);

        var errors = opts.validationAll ? validate(context, filterValidors) : validateFirst(context, filterValidors);
      ...
      if (_classPrivateFieldGet(this, _asyncValidatorMap).size) {
        var _filterValidors = this._filterByTrigger(_classPrivateFieldGet(this, _asyncValidatorMap), opts.trigger);

        var result = opts.validationAll ? asyncValidate(context, _filterValidors) : asyncValidateFirst(context, _filterValidors);
...
var FormControl = /*#__PURE__*/function (_AbstractControl) {
  ...
  function FormControl() {
    ...
    _defineProperty(_assertThisInitialized(_this), "validation", void 0);

    _defineProperty(_assertThisInitialized(_this), "statusSubject", void 0);

    _defineProperty(_assertThisInitialized(_this), "stateSubject", void 0);

    _defineProperty(_assertThisInitialized(_this), "currentTrigger", void 0);

    _defineProperty(_assertThisInitialized(_this), "valueChangelisteners", []);
  ...
  _createClass(FormControl, [{
    key: "add",
    value: function add(path, control) {
      throw new Error("Method not implemented.");
    }
  }, {
    key: "getControl",
    value: function getControl(path) {
      throw new Error("Method not implemented.");
    }
    /**
     * 值改变订阅器
     ...
     * @returns 
     */
    function registerValueChange(listener) {
      var _this2 = this;
      ...
      return function () {
        ...
        var index = indexOf(_context = _this2.valueChangelisteners).call(_context, listener);

        if (index > -1) {
          var _context2;

          splice(_context2 = _this2.valueChangelisteners).call(_context2, index, 1);
        }
      };
    }
    /**
    ...
    value: function setValue(value) {
      ...
      var opts = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      this.value = value;
      this.currentTrigger = (_opts$trigger = opts === null || opts === void 0 ? void 0 : opts.trigger) !== null && _opts$trigger !== void 0 ? _opts$trigger : null;

      if (this.valueChangelisteners.length && opts.emitModelToViewChange !== false) {
        var _context3;

        forEach$3(_context3 = this.valueChangelisteners).call(_context3, function (listener) {
          return listener(_this3.value);
        });
      }
    ...
    get: function get() {
      ...
      return includes(_context4 = ['VALID', 'INVALID', 'VALIDATING']).call(_context4, this.status);
    }
  }, {
    key: "getState",
    ...
    value: function validity() {
      ...
      if (this.enabled) {
        ...
        this.validation.run(this.getState(), {
          subscriber: function subscriber(errors) {
            _this4.errors = errors;
            _this4.status = _this4.errors ? FORM_STATUS.INVALID : FORM_STATUS.VALID;
    ...
    value: function _initValidator() {
      ...
      this.validation = new Validation(opts.validator, opts.asyncValidator, 'change');
    }
  }, {
    key: "_initNotify",
...
var FormGroup = /*#__PURE__*/function (_AbstractControl) {
  ...
  _createClass(FormGroup, [{
    ...
    value: function _setControls(controls) {
      ...
      forEach$3(_context = keys$2(controls)).call(_context, function (name) {
    ...
    value: function flush() {
      ...
      forEach$3(_context2 = this.queue).call(_context2, function (job) {
        var name = job.name,
            state = job.state;
        _this3.value[name] = state.value;
        _this3.errors[name] = state.errors;
        _this3.status[name] = state.status;
      });
